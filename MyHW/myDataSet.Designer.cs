...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ...
                " UnitPrice between @low and @high";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@low", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@high", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.NVarChar, 40, global::System.Data.ParameterDirection.Input, 0, 0, "ProductName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fillbetween(DataSet1.ProductsDataTable dataTable, global::System.Nullable<decimal> low, global::System.Nullable<decimal> high) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((low.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(low.Value));
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            if ((high.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(high.Value));
            }
            else {
        ...
        public virtual DataSet1.ProductsDataTable GetDataBybetween(global::System.Nullable<decimal> low, global::System.Nullable<decimal> high) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((low.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(low.Value));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int Filllikename(DataSet1.ProductsDataTable dataTable, string name) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSet1.ProductsDataTable GetDataBy(string name) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
